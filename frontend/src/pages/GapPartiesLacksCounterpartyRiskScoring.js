...
/**
 * Gap/CFS Feature Page: `parties` lacks counterparty-risk scoring.
 * Slug: parties-lacks-counterparty-risk-scoring
 * Backend: /api/gap-parties-lacks-counterparty-risk-scoring
 */
export default function PartiesLacksCounterpartyRiskScoringPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-parties-lacks-counterparty-risk-scoring', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`parties` lacks counterparty-risk scoring.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`parties` lacks counterparty-risk scoring.</p>
