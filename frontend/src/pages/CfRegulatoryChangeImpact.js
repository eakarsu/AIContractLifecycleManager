...
/**
 * Gap/CFS Feature Page: Regulatory change impact
 * Slug: regulatory-change-impact
 * Backend: /api/cf-regulatory-change-impact
 */
export default function RegulatoryChangeImpactPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-regulatory-change-impact', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Regulatory change impact</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Monitor regulatory updates; flag affected contracts and suggest amendments.</p>
