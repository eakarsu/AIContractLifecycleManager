...
/**
 * Gap/CFS Feature Page: No analytics dashboard (contract spend, risk heatmap, cycle-time).
 * Slug: no-analytics-dashboard-contract-spend-risk-heatmap-cycle-tim
 * Backend: /api/gap-no-analytics-dashboard-contract-spend-risk-heatmap-cycle-tim
 */
export default function NoAnalyticsDashboardContractSpendRiskHeatmapCycleTimPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-analytics-dashboard-contract-spend-risk-heatmap-cycle-tim', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No analytics dashboard (contract spend, risk heatmap, cycle-time).</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No analytics dashboard (contract spend, risk heatmap, cycle-time).</p>
