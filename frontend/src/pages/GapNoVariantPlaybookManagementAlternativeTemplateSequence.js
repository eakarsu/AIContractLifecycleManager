...
/**
 * Gap/CFS Feature Page: No variant/playbook management (alternative template sequences).
 * Slug: no-variant-playbook-management-alternative-template-sequence
 * Backend: /api/gap-no-variant-playbook-management-alternative-template-sequence
 */
export default function NoVariantPlaybookManagementAlternativeTemplateSequencePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-variant-playbook-management-alternative-template-sequence', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No variant/playbook management (alternative template sequences).</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No variant/playbook management (alternative template sequences).</p>
