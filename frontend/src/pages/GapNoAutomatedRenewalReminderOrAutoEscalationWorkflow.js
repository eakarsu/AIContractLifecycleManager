...
/**
 * Gap/CFS Feature Page: No automated renewal-reminder or auto-escalation workflow.
 * Slug: no-automated-renewal-reminder-or-auto-escalation-workflow
 * Backend: /api/gap-no-automated-renewal-reminder-or-auto-escalation-workflow
 */
export default function NoAutomatedRenewalReminderOrAutoEscalationWorkflowPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-automated-renewal-reminder-or-auto-escalation-workflow', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No automated renewal-reminder or auto-escalation workflow.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No automated renewal-reminder or auto-escalation workflow.</p>
