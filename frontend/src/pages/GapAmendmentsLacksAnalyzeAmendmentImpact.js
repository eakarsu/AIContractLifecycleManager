...
/**
 * Gap/CFS Feature Page: `amendments` lacks `/analyze-amendment-impact`.
 * Slug: amendments-lacks-analyze-amendment-impact
 * Backend: /api/gap-amendments-lacks-analyze-amendment-impact
 */
export default function AmendmentsLacksAnalyzeAmendmentImpactPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-amendments-lacks-analyze-amendment-impact', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`amendments` lacks `/analyze-amendment-impact`.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`amendments` lacks `/analyze-amendment-impact`.</p>
