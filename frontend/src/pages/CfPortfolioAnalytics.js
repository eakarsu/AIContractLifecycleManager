...
/**
 * Gap/CFS Feature Page: Portfolio analytics
 * Slug: portfolio-analytics
 * Backend: /api/cf-portfolio-analytics
 */
export default function PortfolioAnalyticsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-portfolio-analytics', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Portfolio analytics</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Analyze your contract portfolio; flag risk concentrations, opportunities for bulk renegotiation, benchmarking vs. market.</p>
