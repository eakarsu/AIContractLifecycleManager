...
/**
 * Gap/CFS Feature Page: Agentic contract negotiation
 * Slug: agentic-contract-negotiation
 * Backend: /api/cf-agentic-contract-negotiation
 */
export default function AgenticContractNegotiationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-contract-negotiation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Agentic contract negotiation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Multi-turn negotiation agent models counterparty constraints; iteratively proposes terms maximizing your priorities.</p>
