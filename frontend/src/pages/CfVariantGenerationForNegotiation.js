...
/**
 * Gap/CFS Feature Page: Variant generation for negotiation
 * Slug: variant-generation-for-negotiation
 * Backend: /api/cf-variant-generation-for-negotiation
 */
export default function VariantGenerationForNegotiationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-variant-generation-for-negotiation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Variant generation for negotiation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Auto-generate 3-5 contract variants with different risk/cost tradeoffs for negotiation optionality.</p>
